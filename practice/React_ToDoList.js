    ...
    return (
      <><br></br><br></br>
        <form Align="center">
          ...
          <label for="dur">Enter Duration Here : &nbsp;&nbsp;&nbsp;&nbsp; </label>
          <input id="dur" type="text" placeholder="Enter Duration"></input>

          <br></br>
          <br></br>
          <input type="button" onClick={this.handler} name="Click!" value={"Click!"}/>
        </form><br></br><br></br>

        <table id="table" Align="center" style={{border: "1px solid rgb(1, 1, 1)"}}>
          <thead>
            <tr>
              <th>Task</th>
              <th>Duration</th>
